 ...
 * </pre>
 *
 * @author Xidan Kou & Cheng Yuanyuan
 *
 */
public class List3<T> extends ListSecondary<T> {
    ...
    public final T removeRightFront() {
        ...
        Node p = this.lastLeft.next; // the old right front
        this.lastLeft.next = p.next; // Assigning new right front
        p.next.previous = this.lastLeft; // create connection to last left
        this.rightLength--;
